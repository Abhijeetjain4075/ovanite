import { f as createLucideIcon, r as reactExports, u as useComposedRefs, j as jsxRuntimeExports, x as reactDomExports, y as ReactDOM, c as cn, S as SecondaryButton, M as MicroBadge, z as ShieldCheck, A as AdminRole, s as LoaderCircle, D as useIsOwner, F as useIsOwnerClaimed, n as useAdminTeam, G as useAddAdmin, H as useSetAdminRole, J as useRemoveAdmin, C as Container, l as Label, I as Input, P as PrimaryButton, K as Principal } from "./index-nAhl1N96.js";
import { P as Primitive, c as composeEventHandlers, g as dispatchDiscreteCustomEvent, d as useLayoutEffect2, b as createContextScope, f as useDirection, u as useControllableState, a as useId, e as createCollection, h as createSlot } from "./index-eq1rYzWb.js";
import { u as useCallbackRef$1, C as Check, R as RefreshCw } from "./index-BbcBv9K7.js";
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        className: "space-y-2",
        "aria-busy": "true",
        children: Array.from({ length: 3 }, (_, i) => `admin-skeleton-${i}`).map(
